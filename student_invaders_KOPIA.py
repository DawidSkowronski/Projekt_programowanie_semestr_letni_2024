...
#eksplozja_rakiety = pygame.transform.smoothscale(self.img0, [self.img0.get_width()*2, self.img0_get_height()*2])
#eksplozja_rakiety_1 = pygame.transform.smoothscale(eksplozja_1, [2, 2])
#eksplozja_rakiety_2 = pygame.transform.smoothscale(eksplozja_2, [2, 2])   NIE DZIAŁA
...
class Pocisk(Byt):
    ...
    def ruchPocisku(self):
        """Przemieszcza pocisk."""
        if self.kto_strzelił == "gracz" or self.kto_strzelił == "rakieta":
